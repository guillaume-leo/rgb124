...
function __onlyVue27Plus(name = "this function") {
  if (vue_demi_exports.isVue3 || vue_demi_exports.version.startsWith("2.7."))
    return;
  throw new Error(`[VueUse] ${name} is only works on Vue 2.7 or above.`);
}
var directiveHooks = {
  mounted: vue_demi_exports.isVue3 ? "mounted" : "inserted",
  updated: vue_demi_exports.isVue3 ? "updated" : "componentUpdated",
  unmounted: vue_demi_exports.isVue3 ? "unmounted" : "unbind"
};
...
function createInjectionState(composable) {
  ...
  const useProvidingState = (...args) => {
    (0, vue_demi_exports.provide)(key, composable(...args));
  };
  const useInjectedState = () => (0, vue_demi_exports.inject)(key);
...
function reactify(fn, options) {
  const unrefFn = (options == null ? void 0 : options.computedGetter) === false ? vue_demi_exports.unref : resolveUnref;
...
function reactiveOmit(obj, ...keys2) {
  ...
  return reactiveComputed(() => Object.fromEntries(Object.entries((0, vue_demi_exports.toRefs)(obj)).filter((e) => !flatKeys.includes(e[0]))));
}
function reactivePick(obj, ...keys2) {
  const flatKeys = keys2.flat();
  return (0, vue_demi_exports.reactive)(Object.fromEntries(flatKeys.map((k) => [k, (0, vue_demi_exports.toRef)(obj, k)])));
}
...
function resolveRef(r) {
  return typeof r === "function" ? (0, vue_demi_exports.computed)(r) : (0, vue_demi_exports.ref)(r);
}
function set(...args) {
  if (args.length === 2) {
...
function syncRef(left, right, options = {}) {
  ...
  if (direction === "both" || direction === "ltr") {
    watchLeft = (0, vue_demi_exports.watch)(left, (newValue) => right.value = transformLTR(newValue), { flush, deep, immediate });
  }
  if (direction === "both" || direction === "rtl") {
    watchRight = (0, vue_demi_exports.watch)(right, (newValue) => left.value = transformRTL(newValue), { flush, deep, immediate });
  }
  return () => {
...
function syncRefs(source, targets, options = {}) {
  ...
  if (!Array.isArray(targets))
    targets = [targets];
  return (0, vue_demi_exports.watch)(source, (newValue) => targets.forEach((target) => target.value = newValue), { flush, deep, immediate });
}
...
function tryOnBeforeMount(fn, sync = true) {
  if ((0, vue_demi_exports.getCurrentInstance)())
    (0, vue_demi_exports.onBeforeMount)(fn);
  else if (sync)
    fn();
  else
...
function tryOnBeforeUnmount(fn) {
  if ((0, vue_demi_exports.getCurrentInstance)())
    (0, vue_demi_exports.onBeforeUnmount)(fn);
}
function tryOnMounted(fn, sync = true) {
  if ((0, vue_demi_exports.getCurrentInstance)())
    (0, vue_demi_exports.onMounted)(fn);
  else if (sync)
    fn();
  else
    (0, vue_demi_exports.nextTick)(fn);
...
function tryOnUnmounted(fn) {
  if ((0, vue_demi_exports.getCurrentInstance)())
    (0, vue_demi_exports.onUnmounted)(fn);
}
function createUntil(r, isNot = false) {
  function toMatch(condition, { flush = "sync", deep = false, timeout, throwOnTimeout } = {}) {
    let stop = null;
    const watcher = new Promise((resolve) => {
      stop = (0, vue_demi_exports.watch)(r, (v) => {
  ...
  function toBe(value, options) {
    ...
    let stop = null;
    const watcher = new Promise((resolve) => {
      stop = (0, vue_demi_exports.watch)([r, value], ([v1, v2]) => {
        if (isNot !== (v1 === v2)) {
          stop == null ? void 0 : stop();
          resolve(v1);
        }
...
function useArrayEvery(list, fn) {
  return (0, vue_demi_exports.computed)(() => resolveUnref(list).every((element, index, array) => fn(resolveUnref(element), index, array)));
}
function useArrayFilter(list, fn) {
  return (0, vue_demi_exports.computed)(() => resolveUnref(list).map((i) => resolveUnref(i)).filter(fn));
}
function useArrayFind(list, fn) {
  return (0, vue_demi_exports.computed)(() => resolveUnref(resolveUnref(list).find((element, index, array) => fn(resolveUnref(element), index, array))));
}
function useArrayFindIndex(list, fn) {
  return (0, vue_demi_exports.computed)(() => resolveUnref(list).findIndex((element, index, array) => fn(resolveUnref(element), index, array)));
}
function useArrayJoin(list, separator) {
  return (0, vue_demi_exports.computed)(() => resolveUnref(list).map((i) => resolveUnref(i)).join(resolveUnref(separator)));
}
function useArrayMap(list, fn) {
  return (0, vue_demi_exports.computed)(() => resolveUnref(list).map((i) => resolveUnref(i)).map(fn));
}
...
function useArraySome(list, fn) {
  return (0, vue_demi_exports.computed)(() => resolveUnref(list).some((element, index, array) => fn(resolveUnref(element), index, array)));
}
...
function useDateFormat(date, formatStr = "HH:mm:ss", options = {}) {
  return (0, vue_demi_exports.computed)(() => formatDate(normalizeDate(resolveUnref(date)), resolveUnref(formatStr), options));
}
function useIntervalFn(cb, interval = 1e3, options = {}) {
  ...
  function resume() {
    if ((0, vue_demi_exports.unref)(interval) <= 0)
      return;
    isActive.value = true;
  ...
  if (immediate && isClient)
    resume();
  if ((0, vue_demi_exports.isRef)(interval) || isFunction(interval)) {
...
function useLastChanged(source, options = {}) {
  var _a2;
  const ms = (0, vue_demi_exports.ref)((_a2 = options.initialValue) != null ? _a2 : null);
  (0, vue_demi_exports.watch)(source, () => ms.value = timestamp(), options);
  return ms;
}
...
function useToString(value) {
  return (0, vue_demi_exports.computed)(() => `${resolveUnref(value)}`);
}
...
function watchArray(source, cb, options) {
  let oldList = (options == null ? void 0 : options.immediate) ? [] : [
    ...source instanceof Function ? source() : Array.isArray(source) ? source : (0, vue_demi_exports.unref)(source)
  ];
...
function watchWithFilter(source, cb, options = {}) {
  ...
  return (0, vue_demi_exports.watch)(source, createFilterWrapper(eventFilter, cb), watchOptions);
}
...
function watchIgnorable(source, cb, options = {}) {
  ...
  if (watchOptions.flush === "sync") {
    ...
    stop = (0, vue_demi_exports.watch)(source, (...args) => {
      if (!ignore.value)
        filteredCb(...args);
    }, watchOptions);
  } else {
    ...
    disposables.push((0, vue_demi_exports.watch)(source, () => {
      syncCounter.value++;
    ...
    disposables.push((0, vue_demi_exports.watch)(source, (...args) => {
...
function whenever(source, cb, options) {
  return (0, vue_demi_exports.watch)(source, (v, ov, onInvalidate) => {
    if (v)
...
function computedAsync(evaluationCallback, initialState, optionsOrRef) {
  ...
  const current = (0, vue_demi_exports.ref)(initialState);
  let counter = 0;
...
var createUnrefFn = (fn) => {
  return function(...args) {
    return fn.apply(this, args.map((i) => (0, vue_demi_exports.unref)(i)));
  };
};
...
function useEventListener(...args) {
  ...
  const stopWatch = (0, vue_demi_exports.watch)(() => unrefElement(target), (el) => {
    cleanup();
    if (!el)
      return;
...
function useAsyncState(promise, initialState, options) {
  ...
  const error = (0, vue_demi_exports.ref)(void 0);
...
function useBase64(target, options) {
  ...
  if ((0, vue_demi_exports.isRef)(target) || isFunction(target))
...
function useSupported(callback, sync = false) {
  const isSupported = (0, vue_demi_exports.ref)();
...
function useMediaQuery(query, options = {}) {
  ...
  (0, vue_demi_exports.watchEffect)(update);
...
var useBroadcastChannel = (options) => {
  ...
  const error = (0, vue_demi_exports.ref)(null);
  const post = (data2) => {
    if (channel.value)
...
function useCloned(source, options = {}) {
  ...
  function sync() {
    cloned.value = clone((0, vue_demi_exports.unref)(source));
  }
  if (!manual && (0, vue_demi_exports.isRef)(source)) {
    (0, vue_demi_exports.watch)(source, sync, __spreadProps$8(__spreadValues$k({}, options), {
      deep,
      immediate
    }));
  } else {
...
function useStorage(key, defaults2, storage, options = {}) {
  ...
  const data = (shallow ? vue_demi_exports.shallowRef : vue_demi_exports.ref)(defaults2);
  if (!storage) {
    try {
...
function useColorMode(options = {}) {
  ...
  const preferredMode = (0, vue_demi_exports.computed)(() => preferredDark.value ? "dark" : "light");
  const store = storageRef || (storageKey == null ? (0, vue_demi_exports.ref)(initialValue) : useStorage(storageKey, initialValue, storage, { window: window2, listenToStorageChanges }));
  ...
  if (emitAuto)
    (0, vue_demi_exports.watch)(preferredMode, () => onChanged(state.value), { flush: "post" });
...
function useCssVar(prop, target, { window: window2 = defaultWindow, initialValue = "" } = {}) {
  ...
  (0, vue_demi_exports.watch)([elRef, () => resolveUnref(prop)], ([el, prop2]) => {
    var _a2;
    if (el && window2) {
  ...
  (0, vue_demi_exports.watch)(variable, (val) => {
    var _a2;
...
function useCycleList(list, options) {
  var _a2;
  const state = (0, vue_demi_exports.shallowRef)((_a2 = options == null ? void 0 : options.initialValue) != null ? _a2 : list[0]);
...
function useDevicePixelRatio({
  ...
  if (!window2) {
    return {
      pixelRatio: (0, vue_demi_exports.ref)(1)
    };
  }
...
function useDisplayMedia(options = {}) {
  var _a2;
  const enabled = (0, vue_demi_exports.ref)((_a2 = options.enabled) != null ? _a2 : false);
  ...
  (0, vue_demi_exports.watch)(enabled, (v) => {
    if (v)
      _start();
    else
      _stop();
...
function useDraggable(target, options = {}) {
  ...
  const position = (0, vue_demi_exports.ref)((_c = resolveUnref(options.initialValue)) != null ? _c : { x: 0, y: 0 });
  ...
  return __spreadProps$42(__spreadValues$e({}, toRefs(position)), {
    ...
    style: (0, vue_demi_exports.computed)(() => `left:${position.value.x}px;top:${position.value.y}px;`)
  });
}
...
function useElementSize(target, initialSize = { width: 0, height: 0 }, options = {}) {
  ...
  (0, vue_demi_exports.watch)(() => unrefElement(target), (ele) => {
...
function useElementVisibility(element, { window: window2 = defaultWindow, scrollTarget } = {}) {
  ...
  (0, vue_demi_exports.watch)(() => unrefElement(element), () => testBounding(), { immediate: true, flush: "post" });
  if (window2) {
...
function useFavicon(newIcon = null, options = {}) {
  ...
  (0, vue_demi_exports.watch)(favicon, (i, o) => {
    if (isString(i) && i !== o)
      applyIcon(i);
  }, { immediate: true });
  return favicon;
...
function useFetch(url, ...args) {
  ...
  const error = (0, vue_demi_exports.shallowRef)(null);
  const data = (0, vue_demi_exports.shallowRef)(initialData);
...
function useFileSystemAccess(options = {}) {
  const {
    ...
    dataType = "Text"
  } = (0, vue_demi_exports.unref)(options);
  ...
  async function open(_options = {}) {
    if (!isSupported.value)
      return;
    const [handle] = await window2.showOpenFilePicker(__spreadValues$a(__spreadValues$a({}, (0, vue_demi_exports.unref)(options)), _options));
  ...
  async function create(_options = {}) {
    if (!isSupported.value)
      return;
    fileHandle.value = await window2.showSaveFilePicker(__spreadValues$a(__spreadValues$a({}, (0, vue_demi_exports.unref)(options)), _options));
    data.value = void 0;
    await updateFile();
    await updateData();
  }
  ...
  async function updateData() {
    var _a2, _b;
    if ((0, vue_demi_exports.unref)(dataType) === "Text")
      data.value = await ((_a2 = file.value) == null ? void 0 : _a2.text());
    if ((0, vue_demi_exports.unref)(dataType) === "ArrayBuffer")
      data.value = await ((_b = file.value) == null ? void 0 : _b.arrayBuffer());
    if ((0, vue_demi_exports.unref)(dataType) === "Blob")
      data.value = file.value;
  }
  (0, vue_demi_exports.watch)(() => (0, vue_demi_exports.unref)(dataType), updateData);
  return {
    isSupported,
    data,
    file,
...
function useFocus(target, options = {}) {
  ...
  (0, vue_demi_exports.watch)(targetElement, () => {
...
var useImage = (options, asyncStateOptions = {}) => {
  ...
  (0, vue_demi_exports.watch)(() => resolveUnref(options), () => state.execute(asyncStateOptions.delay), { deep: true });
  return state;
};
...
function useInfiniteScroll(element, onLoadMore, options = {}) {
  ...
  const state = (0, vue_demi_exports.reactive)(useScroll(element, __spreadProps$22(__spreadValues$82({}, options), {
    offset: __spreadValues$82({
      [direction]: (_b = options.distance) != null ? _b : 0
    }, options.offset)
  })));
  (0, vue_demi_exports.watch)(() => state.arrivedState[direction], async (v) => {
    var _a22, _b2;
    if (v) {
    ...
    get(target2, prop, rec) {
      ...
      if (!(prop in refs)) {
        if (/[+_-]/.test(prop)) {
          ...
          refs[prop] = (0, vue_demi_exports.computed)(() => keys2.every((key) => (0, vue_demi_exports.unref)(proxy[key])));
        } else {
          refs[prop] = (0, vue_demi_exports.ref)(false);
        }
      }
      const r = Reflect.get(target2, prop, rec);
      return useReactive ? (0, vue_demi_exports.unref)(r) : r;
    }
  });
  return proxy;
}
...
function useMediaControls(target, options = {}) {
  ...
  (0, vue_demi_exports.watch)(volume, (vol) => {
    const el = resolveUnref(target);
    if (!el)
      return;
    el.volume = vol;
  });
  (0, vue_demi_exports.watch)(muted, (mute) => {
    const el = resolveUnref(target);
    if (!el)
      return;
    el.muted = mute;
  });
  (0, vue_demi_exports.watch)(rate, (rate2) => {
    const el = resolveUnref(target);
    if (!el)
      return;
...
var getMapVue2Compat = () => {
  const data = (0, vue_demi_exports.reactive)({});
  return {
    get: (key) => data[key],
    set: (key, value) => (0, vue_demi_exports.set)(data, key, value),
    has: (key) => hasOwn(data, key),
    delete: (key) => (0, vue_demi_exports.del)(data, key),
    clear: () => {
      Object.keys(data).forEach((key) => {
        (0, vue_demi_exports.del)(data, key);
      });
    }
  };
};
function useMemoize(resolver, options) {
  const initCache = () => {
    if (options == null ? void 0 : options.cache)
      return (0, vue_demi_exports.reactive)(options.cache);
    if (vue_demi_exports.isVue2)
      return getMapVue2Compat();
    return (0, vue_demi_exports.reactive)(/* @__PURE__ */ new Map());
  };
...
function useMouseInElement(target, options = {}) {
  ...
  if (window2) {
    stop = (0, vue_demi_exports.watch)([targetRef, x, y], () => {
...
function useNow(options = {}) {
  ...
  const now2 = (0, vue_demi_exports.ref)(new Date());
...
function useObjectUrl(object) {
  ...
  (0, vue_demi_exports.watch)(() => (0, vue_demi_exports.unref)(object), (newObject) => {
    release();
    if (newObject)
...
function useOffsetPagination(options) {
  ...
  const pageCount = (0, vue_demi_exports.computed)(() => Math.max(1, Math.ceil((0, vue_demi_exports.unref)(total) / (0, vue_demi_exports.unref)(currentPageSize))));
...
function useScrollLock(element, initialState = false) {
  ...
  let initialOverflow;
  (0, vue_demi_exports.watch)(resolveRef(element), (el) => {
    if (el) {
      const ele = el;
...
function useSorted(...args) {
  ...
  if (!dirty)
    return (0, vue_demi_exports.computed)(() => sortFn([...(0, vue_demi_exports.unref)(source)], compareFn));
  (0, vue_demi_exports.watchEffect)(() => {
    const result = sortFn((0, vue_demi_exports.unref)(source), compareFn);
...
function useSpeechRecognition(options = {}) {
  ...
  if (isSupported.value) {
    ...
    recognition.lang = (0, vue_demi_exports.unref)(lang);
    recognition.onstart = () => {
      isFinal.value = false;
    };
...
function useSpeechSynthesis(text, options = {}) {
  ...
  const bindEventsForUtterance = (utterance2) => {
    utterance2.lang = (0, vue_demi_exports.unref)(lang);
    utterance2.voice = (0, vue_demi_exports.unref)(options.voice) || null;
...
function useStyleTag(css, options = {}) {
  ...
  const load = () => {
    ...
    if (isLoaded.value)
      return;
    stop = (0, vue_demi_exports.watch)(cssRef, (value) => {
...
function useTextareaAutosize(options) {
  ...
  (0, vue_demi_exports.watch)([input, textarea], triggerResize, { immediate: true });
...
function useTimeAgo(time, options = {}) {
  ...
  const timeAgo = (0, vue_demi_exports.computed)(() => foramtTimeAgo(new Date(resolveUnref(time)), options, (0, vue_demi_exports.unref)(now2.value)));
  if (exposeControls) {
...
function useTitle(newTitle = null, options = {}) {
  ...
  function format(t) {
    ...
    return isFunction(template) ? template(t) : (0, vue_demi_exports.unref)(template).replace(/%s/g, t);
  }
  (0, vue_demi_exports.watch)(title, (t, o) => {
    if (t !== o && document2)
...
function useTransition(source, options = {}) {
  ...
  const currentTransition = (0, vue_demi_exports.computed)(() => {
    const t = (0, vue_demi_exports.unref)(transition);
    return isFunction(t) ? t : createEasingFunction(t);
  });
  const sourceValue = (0, vue_demi_exports.computed)(() => {
    const s = (0, vue_demi_exports.unref)(source);
    return isNumber(s) ? s : s.map(vue_demi_exports.unref);
  });
  const sourceVector = (0, vue_demi_exports.computed)(() => isNumber(sourceValue.value) ? [sourceValue.value] : sourceValue.value);
  const outputVector = (0, vue_demi_exports.ref)(sourceVector.value.slice(0));
  let currentDuration;
  let diffVector;
  let endAt;
  let startAt;
  ...
  const start = () => {
    pause();
    currentDuration = (0, vue_demi_exports.unref)(duration);
  ...
  (0, vue_demi_exports.watch)(sourceVector, () => {
    if ((0, vue_demi_exports.unref)(disabled))
      return;
    if ((0, vue_demi_exports.unref)(delay) <= 0)
      start();
    else
      timeout.start();
  }, { deep: true });
  (0, vue_demi_exports.watch)(() => (0, vue_demi_exports.unref)(disabled), (v) => {
    if (v) {
  ...
  return (0, vue_demi_exports.computed)(() => {
    const targetVector = (0, vue_demi_exports.unref)(disabled) ? sourceVector : outputVector;
...
function useUserMedia(options = {}) {
  ...
  const videoDeviceId = (0, vue_demi_exports.ref)(options.videoDeviceId);
  const audioDeviceId = (0, vue_demi_exports.ref)(options.audioDeviceId);
  const { navigator = defaultNavigator } = options;
  const isSupported = useSupported(() => {
    var _a22;
  ...
  (0, vue_demi_exports.watch)([videoDeviceId, audioDeviceId], () => {
...
function useVModel(props, key, emit, options = {}) {
  ...
  if (passive) {
    ...
    (0, vue_demi_exports.watch)(() => props[key], (v) => proxy.value = cloneFn(v));
    (0, vue_demi_exports.watch)(proxy, (v) => {
      if (v !== props[key] || deep)
        _emit(event, v);
    }, { deep });
    return proxy;
...
function useWindowScroll({ window: window2 = defaultWindow } = {}) {
  ...
  const x = (0, vue_demi_exports.ref)(window2.pageXOffset);
  const y = (0, vue_demi_exports.ref)(window2.pageYOffset);
...
//# sourceMappingURL=chunk-L5BWF2QT.js.map
