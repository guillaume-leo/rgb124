...
import { ssrRenderAttr, ssrRenderComponent, ssrRenderSlot, ssrRenderAttrs, ssrRenderList, ssrRenderStyle, ssrInterpolate } from 'file:///Users/guillaumequet/code/perso/projects-2022/rgb124/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Shape, {
        style: unref(currentPage) === "/" ? null : { display: "none" }
      }, null, _parent));
...
//# sourceMappingURL=default.1734f7ba.mjs.map
